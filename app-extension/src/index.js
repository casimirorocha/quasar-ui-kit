...
function extendConf (conf, api) {
  ...
  conf.css.push('~quasar-ui-daddybrasil/src/index.sass')
}
...
export default function (api) {
  ...
  // api.registerDescribeApi('MyComponent', '~quasar-ui-daddybrasil/src/components/MyComponent.json')

  // Uncomment the line below if you provide a JSON API for your directive
  // api.registerDescribeApi('my-directive', '~quasar-ui-daddybrasil/src/directives/my-directive.json')
